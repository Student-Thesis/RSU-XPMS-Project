                        ...
                        <div class="form_section inner_information padding_infor_info">
                            ...
                            <form id="userEditForm" action="{{ route('users.update', $user->id) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="department_id" required>
                                                ...
                                                <option value="2"
                                                    {{ old('department_id', $user->department_id) == 2 ? 'selected' : '' }}>
                                                    Manager</option>
                                                <option value="3"
                                                    {{ old('department_id', $user->department_id) == 3 ? 'selected' : '' }}>
                                                    Coordinator</option>
                                                <option value="4"
                                                    {{ old('department_id', $user->department_id) == 4 ? 'selected' : '' }}>
                                                    User</option>
                                            </select>
                                            @error('department_id')
                                    ...
                                    <div class="col-md-6">
                                        <label>Avatar</label>
                                        <input type="file" class="form-control-file" name="avatar" id="avatarInput"
                                            accept="image/*">
