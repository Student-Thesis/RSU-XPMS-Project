                    ...
                    <div class="row g-3">
                        ...
                        @foreach ($yesNo as $name => $label)
                            <div class="col-6 col-md-4">
                                ...
                                {{-- Extra info only for MOA/MOU: show MOU file + MOU link from PROPOSALS table --}}
                                @if($name === 'moa_mou' && ($project->mou_path || $project->mou_link))
                                    <div class="mt-1 small">
                                        ...
                                        @if($project->mou_link)
                                            <div>
                                                <strong>MOU Link:</strong>
                                                <a href="{{ $project->mou_link }}"
                                                   target="_blank"
                                                   rel="noopener noreferrer">
                                                    {{ $project->mou_link }}
                                                </a>
                        ...
                        <div class="col-md-4">
                            ...
                            {{-- Extra info under Drive Link: MOA file + MOA link from PROPOSALS table --}}
                            @if($project->moa_path || $project->moa_link)
                                <div class="mt-1 small">
                                    @if($project->moa_path)
                                        <div>
                                            <strong>MOA File:</strong>
                                            <a href="{{ asset('storage/'.$project->moa_path) }}"
                                               target="_blank"
                                               rel="noopener noreferrer">
                                                View
                                            </a>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea
                                ...
                                class="form-control"
                                rows="2"
                            >{{ old('remarks', $project->remarks) }}</textarea>
                        </div>
