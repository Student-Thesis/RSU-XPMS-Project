    ...
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <h3 class="mb-0">Edit Proposals</h3>
                </div>
                ...
                <form method="POST" action="{{ route('projects.update', $project->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="leader" value="{{ old('leader', $project->leader) }}"
                                class="form-control">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="team_members"
                                value="{{ old('team_members', $project->team_members) }}" class="form-control">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="organization_name" class="form-control"
                                value="{{ old('organization_name', $project->organization_name) }}"
                        ...
                        {{-- <div class="col-md-6">
                                ...
                                <input
                                    ...
                                    name="mou_link"
                                    class="form-control"
                                    value="{{ old('mou_link', $project->mou_link) }}"
                        ...
                        @foreach ($yesNo as $name => $label)
                            <div class="col-md-4">
                                ...
                                <select name="{{ $name }}" class="form-control">
                                    <option value="0"
                                        {{ (string) $value === '0' || is_null($value) ? 'selected' : '' }}>
                                        No
                                    </option>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" step="0.01" min="0" name="approved_budget"
                                value="{{ old('approved_budget', $project->approved_budget) }}" class="form-control">
                        </div>

                        <div class="col-md-4">
                            <label class="form-label">Expenditure</label>
                            <input type="number" step="0.01" min="0" name="expenditure"
                                value="{{ old('expenditure', $project->expenditure) }}" class="form-control">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="source_of_funds"
                                value="{{ old('source_of_funds', $project->source_of_funds) }}" class="form-control">
                        </div>

                        <div class="col-md-6">
                            <label class="form-label">Partner</label>
                            <input type="text" name="partner" value="{{ old('partner', $project->partner) }}"
                                class="form-control">
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="status" class="form-control status-select">
                                <option value="Pending" class="status-cancelled"
                                    {{ $statusValue === 'Pending' ? 'selected' : '' }}>
                                    Pending
                                </option>
                                <option value="Ongoing" class="status-ongoing"
                        ...
                        {{-- Drive Link + MOA attachments (optional extra info) --}}
                        <div class="col-md-4">
                            <label class="form-label">Drive Link</label>
                            <input type="url" name="drive_link" id="drive_link"
                                value="{{ old('drive_link', $project->drive_link) }}" class="form-control"
                                placeholder="https://example.com/your-document" oninput="validateUrl(this)">
                            <script>
                            ...
                            @if ($project->moa_path || $project->moa_link)
                                <div class="mt-1 small">
                                    @if ($project->moa_path)
                                        <div>
                                            <strong>MOA File:</strong>
                                            <a href="{{ asset('storage/' . $project->moa_path) }}" target="_blank"
                                                rel="noopener noreferrer">
                                                View
                                            </a>
                                            &nbsp;|&nbsp;
                                            <a href="{{ asset('storage/' . $project->moa_path) }}" download
                                                rel="noopener noreferrer">
                                                Download
                                            </a>
                                        </div>
                                    ...
                                    @if ($project->moa_link)
                                        <div>
                                            <strong>MOA Link:</strong>
                                            <a href="{{ $project->moa_link }}" target="_blank"
                                                rel="noopener noreferrer">
                                                {{ $project->moa_link }}
                                            </a>
                                        </div>
