                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="classification" class="form-control" required>
                                <option value="Program" {{ old('classification')=='Program' ? 'selected' : '' }}>Program</option>
                                <option value="Project" {{ old('classification')=='Project' ? 'selected' : '' }}>Project</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="mou_link" class="form-control"
                                   value="{{ old('mou_link') }}" placeholder="Enter G-Drive Link">
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" step="0.01" name="approved_budget" value="{{ old('approved_budget') }}" class="form-control">
                        </div>

                        <div class="col-md-4">
                            <label class="form-label">Expenditure</label>
                            <input type="number" step="0.01" name="expenditure" value="{{ old('expenditure') }}" class="form-control">
                        </div>

                        <div class="col-md-4">
                            <label class="form-label">Fund Utilization Rate</label>
                            <input type="text" name="fund_utilization_rate" value="{{ old('fund_utilization_rate') }}" class="form-control">
                        </div>

                        <div class="col-md-6">
                            <label class="form-label">Source of Funds</label>
                            <input type="text" name="source_of_funds" value="{{ old('source_of_funds') }}" class="form-control">
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="documentation_report"
                                value="{{ old('documentation_report') }}" class="form-control">
                        </div>
